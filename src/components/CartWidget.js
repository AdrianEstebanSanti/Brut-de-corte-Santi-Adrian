...
const CartWidget = () => {
  ...
  return (
    <div >
        <Link to='/compra' className='btn btn-primary cartWidget position-relative'   role="button">
  ...
  <span className='position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger'> {carritoContext.getTotalCount()}</span>
