...
const CartWidget = () => {
  ...
  const {quantityCart, cart} = useContext (CartContex)
  ...
  return (
    <div >
        <Link to='./Cart/Cart.js' className='btn btn-primary cartWidget'   role="button">
...
<span className='m-1'>{quantityCart()}</span>
</Link>
    </div>
  )
}
